...
ifeq ($(config),debug)
  OBJDIR     = obj/Debug/Tut\ 02\ Fragment\ Position
  TARGETDIR  = .
  TARGET     = $(TARGETDIR)/Tut\ 02\ Fragment\ PositionD.exe
...
ifeq ($(config),release)
  OBJDIR     = obj/Release/Tut\ 02\ Fragment\ Position
  TARGETDIR  = .
  TARGET     = $(TARGETDIR)/Tut\ 02\ Fragment\ Position.exe
...
$(TARGET): $(GCH) $(OBJECTS) $(LDDEPS) $(RESOURCES)
	@echo Linking Tut 02 Fragment Position
	$(SILENT) $(LINKCMD)
	$(POSTBUILDCMDS)
...
clean:
	@echo Cleaning Tut 02 Fragment Position
ifeq (posix,$(SHELLTYPE))
	$(SILENT) rm -f  $(TARGET)
	$(SILENT) rm -rf $(OBJDIR)
else
...
$(OBJDIR)/FragPosition.o: FragPosition.cpp
	@echo $(notdir $<)

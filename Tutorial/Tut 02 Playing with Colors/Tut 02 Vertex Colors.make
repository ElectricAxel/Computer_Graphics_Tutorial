...
ifeq ($(config),debug)
  OBJDIR     = obj/Debug/Tut\ 02\ Vertex\ Colors
  TARGETDIR  = .
  TARGET     = $(TARGETDIR)/Tut\ 02\ Vertex\ ColorsD.exe
...
ifeq ($(config),release)
  OBJDIR     = obj/Release/Tut\ 02\ Vertex\ Colors
  TARGETDIR  = .
  TARGET     = $(TARGETDIR)/Tut\ 02\ Vertex\ Colors.exe
...
$(TARGET): $(GCH) $(OBJECTS) $(LDDEPS) $(RESOURCES)
	@echo Linking Tut 02 Vertex Colors
	$(SILENT) $(LINKCMD)
	$(POSTBUILDCMDS)
...
clean:
	@echo Cleaning Tut 02 Vertex Colors
ifeq (posix,$(SHELLTYPE))
	$(SILENT) rm -f  $(TARGET)
	$(SILENT) rm -rf $(OBJDIR)
else

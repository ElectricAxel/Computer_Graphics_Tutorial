...
ifeq ($(config),debug)
  OBJDIR     = obj/Debug/Tut\ 03\ CPU\ Position\ Offset
  TARGETDIR  = .
  TARGET     = $(TARGETDIR)/Tut\ 03\ CPU\ Position\ OffsetD.exe
...
ifeq ($(config),release)
  OBJDIR     = obj/Release/Tut\ 03\ CPU\ Position\ Offset
  TARGETDIR  = .
  TARGET     = $(TARGETDIR)/Tut\ 03\ CPU\ Position\ Offset.exe
...
$(TARGET): $(GCH) $(OBJECTS) $(LDDEPS) $(RESOURCES)
	@echo Linking Tut 03 CPU Position Offset
	$(SILENT) $(LINKCMD)
	$(POSTBUILDCMDS)
...
clean:
	@echo Cleaning Tut 03 CPU Position Offset
ifeq (posix,$(SHELLTYPE))
	$(SILENT) rm -f  $(TARGET)
	$(SILENT) rm -rf $(OBJDIR)
else

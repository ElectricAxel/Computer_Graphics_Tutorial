...
ifeq ($(config),debug)
  OBJDIR     = obj/Debug/Tut\ 03\ Fragment\ Change\ Color
  TARGETDIR  = .
  TARGET     = $(TARGETDIR)/Tut\ 03\ Fragment\ Change\ ColorD.exe
...
ifeq ($(config),release)
  OBJDIR     = obj/Release/Tut\ 03\ Fragment\ Change\ Color
  TARGETDIR  = .
  TARGET     = $(TARGETDIR)/Tut\ 03\ Fragment\ Change\ Color.exe
...
$(TARGET): $(GCH) $(OBJECTS) $(LDDEPS) $(RESOURCES)
	@echo Linking Tut 03 Fragment Change Color
	$(SILENT) $(LINKCMD)
	$(POSTBUILDCMDS)
...
clean:
	@echo Cleaning Tut 03 Fragment Change Color
ifeq (posix,$(SHELLTYPE))
	$(SILENT) rm -f  $(TARGET)
	$(SILENT) rm -rf $(OBJDIR)
else

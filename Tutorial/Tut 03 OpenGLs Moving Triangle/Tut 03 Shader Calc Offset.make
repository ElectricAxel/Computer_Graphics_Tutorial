...
ifeq ($(config),debug)
  OBJDIR     = obj/Debug/Tut\ 03\ Shader\ Calc\ Offset
  TARGETDIR  = .
  TARGET     = $(TARGETDIR)/Tut\ 03\ Shader\ Calc\ OffsetD.exe
...
ifeq ($(config),release)
  OBJDIR     = obj/Release/Tut\ 03\ Shader\ Calc\ Offset
  TARGETDIR  = .
  TARGET     = $(TARGETDIR)/Tut\ 03\ Shader\ Calc\ Offset.exe
...
$(TARGET): $(GCH) $(OBJECTS) $(LDDEPS) $(RESOURCES)
	@echo Linking Tut 03 Shader Calc Offset
	$(SILENT) $(LINKCMD)
	$(POSTBUILDCMDS)
...
clean:
	@echo Cleaning Tut 03 Shader Calc Offset
ifeq (posix,$(SHELLTYPE))
	$(SILENT) rm -f  $(TARGET)
	$(SILENT) rm -rf $(OBJDIR)
else
...
$(OBJDIR)/vertCalcOffset.o: vertCalcOffset.cpp
	@echo $(notdir $<)

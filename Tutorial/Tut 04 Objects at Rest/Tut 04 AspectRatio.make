...
ifeq ($(config),debug)
  OBJDIR     = obj/Debug/Tut\ 04\ AspectRatio
  TARGETDIR  = .
  TARGET     = $(TARGETDIR)/Tut\ 04\ AspectRatioD.exe
...
ifeq ($(config),release)
  OBJDIR     = obj/Release/Tut\ 04\ AspectRatio
  TARGETDIR  = .
  TARGET     = $(TARGETDIR)/Tut\ 04\ AspectRatio.exe
...
$(TARGET): $(GCH) $(OBJECTS) $(LDDEPS) $(RESOURCES)
	@echo Linking Tut 04 AspectRatio
	$(SILENT) $(LINKCMD)
	$(POSTBUILDCMDS)
...
clean:
	@echo Cleaning Tut 04 AspectRatio
ifeq (posix,$(SHELLTYPE))
	$(SILENT) rm -f  $(TARGET)
	$(SILENT) rm -rf $(OBJDIR)
else
...
$(OBJDIR)/AspectRatio.o: AspectRatio.cpp
	@echo $(notdir $<)

...
ifeq ($(config),debug)
  OBJDIR     = obj/Debug/Tut\ 04\ Orthographic\ Cube
  TARGETDIR  = .
  TARGET     = $(TARGETDIR)/Tut\ 04\ Orthographic\ CubeD.exe
...
ifeq ($(config),release)
  OBJDIR     = obj/Release/Tut\ 04\ Orthographic\ Cube
  TARGETDIR  = .
  TARGET     = $(TARGETDIR)/Tut\ 04\ Orthographic\ Cube.exe
...
$(TARGET): $(GCH) $(OBJECTS) $(LDDEPS) $(RESOURCES)
	@echo Linking Tut 04 Orthographic Cube
	$(SILENT) $(LINKCMD)
	$(POSTBUILDCMDS)
...
clean:
	@echo Cleaning Tut 04 Orthographic Cube
ifeq (posix,$(SHELLTYPE))
	$(SILENT) rm -f  $(TARGET)
	$(SILENT) rm -rf $(OBJDIR)
else
...
$(OBJDIR)/OrthoCube.o: OrthoCube.cpp
	@echo $(notdir $<)

...
ifeq ($(config),debug)
  OBJDIR     = obj/Debug/Tut\ 04\ ShaderPerspective
  TARGETDIR  = .
  TARGET     = $(TARGETDIR)/Tut\ 04\ ShaderPerspectiveD.exe
...
ifeq ($(config),release)
  OBJDIR     = obj/Release/Tut\ 04\ ShaderPerspective
  TARGETDIR  = .
  TARGET     = $(TARGETDIR)/Tut\ 04\ ShaderPerspective.exe
...
$(TARGET): $(GCH) $(OBJECTS) $(LDDEPS) $(RESOURCES)
	@echo Linking Tut 04 ShaderPerspective
	$(SILENT) $(LINKCMD)
	$(POSTBUILDCMDS)
...
clean:
	@echo Cleaning Tut 04 ShaderPerspective
ifeq (posix,$(SHELLTYPE))
	$(SILENT) rm -f  $(TARGET)
	$(SILENT) rm -rf $(OBJDIR)
else
...
$(OBJDIR)/ShaderPerspective.o: ShaderPerspective.cpp
	@echo $(notdir $<)

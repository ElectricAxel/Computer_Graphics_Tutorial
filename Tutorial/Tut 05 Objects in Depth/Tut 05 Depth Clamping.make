...
ifeq ($(config),debug)
  OBJDIR     = obj/Debug/Tut\ 05\ Depth\ Clamping
  TARGETDIR  = .
  TARGET     = $(TARGETDIR)/Tut\ 05\ Depth\ ClampingD.exe
...
ifeq ($(config),release)
  OBJDIR     = obj/Release/Tut\ 05\ Depth\ Clamping
  TARGETDIR  = .
  TARGET     = $(TARGETDIR)/Tut\ 05\ Depth\ Clamping.exe
...
$(TARGET): $(GCH) $(OBJECTS) $(LDDEPS) $(RESOURCES)
	@echo Linking Tut 05 Depth Clamping
	$(SILENT) $(LINKCMD)
	$(POSTBUILDCMDS)
...
clean:
	@echo Cleaning Tut 05 Depth Clamping
ifeq (posix,$(SHELLTYPE))
	$(SILENT) rm -f  $(TARGET)
	$(SILENT) rm -rf $(OBJDIR)
else
...
$(OBJDIR)/DepthClamping.o: DepthClamping.cpp
	@echo $(notdir $<)

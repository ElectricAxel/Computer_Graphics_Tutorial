...
ifeq ($(config),debug)
  OBJDIR     = obj/Debug/Tut\ 05\ Depth\ Fighting
  TARGETDIR  = .
  TARGET     = $(TARGETDIR)/Tut\ 05\ Depth\ FightingD.exe
...
ifeq ($(config),release)
  OBJDIR     = obj/Release/Tut\ 05\ Depth\ Fighting
  TARGETDIR  = .
  TARGET     = $(TARGETDIR)/Tut\ 05\ Depth\ Fighting.exe
...
$(TARGET): $(GCH) $(OBJECTS) $(LDDEPS) $(RESOURCES)
	@echo Linking Tut 05 Depth Fighting
	$(SILENT) $(LINKCMD)
	$(POSTBUILDCMDS)
...
clean:
	@echo Cleaning Tut 05 Depth Fighting
ifeq (posix,$(SHELLTYPE))
	$(SILENT) rm -f  $(TARGET)
	$(SILENT) rm -rf $(OBJDIR)
else
...
$(OBJDIR)/DepthFighting.o: DepthFighting.cpp
	@echo $(notdir $<)

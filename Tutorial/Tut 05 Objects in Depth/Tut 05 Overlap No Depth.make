...
ifeq ($(config),debug)
  OBJDIR     = obj/Debug/Tut\ 05\ Overlap\ No\ Depth
  TARGETDIR  = .
  TARGET     = $(TARGETDIR)/Tut\ 05\ Overlap\ No\ DepthD.exe
...
ifeq ($(config),release)
  OBJDIR     = obj/Release/Tut\ 05\ Overlap\ No\ Depth
  TARGETDIR  = .
  TARGET     = $(TARGETDIR)/Tut\ 05\ Overlap\ No\ Depth.exe
...
$(TARGET): $(GCH) $(OBJECTS) $(LDDEPS) $(RESOURCES)
	@echo Linking Tut 05 Overlap No Depth
	$(SILENT) $(LINKCMD)
	$(POSTBUILDCMDS)
...
clean:
	@echo Cleaning Tut 05 Overlap No Depth
ifeq (posix,$(SHELLTYPE))
	$(SILENT) rm -f  $(TARGET)
	$(SILENT) rm -rf $(OBJDIR)
else
...
$(OBJDIR)/OverlapNoDepth.o: OverlapNoDepth.cpp
	@echo $(notdir $<)

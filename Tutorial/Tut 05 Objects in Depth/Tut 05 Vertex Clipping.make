...
ifeq ($(config),debug)
  OBJDIR     = obj/Debug/Tut\ 05\ Vertex\ Clipping
  TARGETDIR  = .
  TARGET     = $(TARGETDIR)/Tut\ 05\ Vertex\ ClippingD.exe
...
ifeq ($(config),release)
  OBJDIR     = obj/Release/Tut\ 05\ Vertex\ Clipping
  TARGETDIR  = .
  TARGET     = $(TARGETDIR)/Tut\ 05\ Vertex\ Clipping.exe
...
$(TARGET): $(GCH) $(OBJECTS) $(LDDEPS) $(RESOURCES)
	@echo Linking Tut 05 Vertex Clipping
	$(SILENT) $(LINKCMD)
	$(POSTBUILDCMDS)
...
clean:
	@echo Cleaning Tut 05 Vertex Clipping
ifeq (posix,$(SHELLTYPE))
	$(SILENT) rm -f  $(TARGET)
	$(SILENT) rm -rf $(OBJDIR)
else
...
$(OBJDIR)/VertexClipping.o: VertexClipping.cpp
	@echo $(notdir $<)

...
ifeq ($(config),debug)
  OBJDIR     = obj/Debug/Tut\ 06\ Hierarchy
  TARGETDIR  = .
  TARGET     = $(TARGETDIR)/Tut\ 06\ HierarchyD.exe
...
ifeq ($(config),release)
  OBJDIR     = obj/Release/Tut\ 06\ Hierarchy
  TARGETDIR  = .
  TARGET     = $(TARGETDIR)/Tut\ 06\ Hierarchy.exe
...
clean:
	@echo Cleaning Tut 06 Hierarchy
ifeq (posix,$(SHELLTYPE))
	$(SILENT) rm -f  $(TARGET)
	$(SILENT) rm -rf $(OBJDIR)
else
...
$(OBJDIR)/Hierarchy.o: Hierarchy.cpp
	@echo $(notdir $<)

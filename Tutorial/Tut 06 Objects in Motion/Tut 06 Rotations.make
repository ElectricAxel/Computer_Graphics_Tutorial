...
ifeq ($(config),debug)
  OBJDIR     = obj/Debug/Tut\ 06\ Rotations
  TARGETDIR  = .
  TARGET     = $(TARGETDIR)/Tut\ 06\ RotationsD.exe
...
ifeq ($(config),release)
  OBJDIR     = obj/Release/Tut\ 06\ Rotations
  TARGETDIR  = .
  TARGET     = $(TARGETDIR)/Tut\ 06\ Rotations.exe
...
clean:
	@echo Cleaning Tut 06 Rotations
ifeq (posix,$(SHELLTYPE))
	$(SILENT) rm -f  $(TARGET)
	$(SILENT) rm -rf $(OBJDIR)
else
...
$(OBJDIR)/Rotations.o: Rotations.cpp
	@echo $(notdir $<)

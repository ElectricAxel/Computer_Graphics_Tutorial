...
ifeq ($(config),debug)
  OBJDIR     = obj/Debug/Tut\ 06\ Translation
  TARGETDIR  = .
  TARGET     = $(TARGETDIR)/Tut\ 06\ TranslationD.exe
...
ifeq ($(config),release)
  OBJDIR     = obj/Release/Tut\ 06\ Translation
  TARGETDIR  = .
  TARGET     = $(TARGETDIR)/Tut\ 06\ Translation.exe
...
$(TARGET): $(GCH) $(OBJECTS) $(LDDEPS) $(RESOURCES)
	@echo Linking Tut 06 Translation
	$(SILENT) $(LINKCMD)
	$(POSTBUILDCMDS)
...
clean:
	@echo Cleaning Tut 06 Translation
ifeq (posix,$(SHELLTYPE))
	$(SILENT) rm -f  $(TARGET)
	$(SILENT) rm -rf $(OBJDIR)
else
...
$(OBJDIR)/Translation.o: Translation.cpp
	@echo $(notdir $<)

...
ifeq ($(config),debug)
  OBJDIR     = obj/Debug/Tut\ 07\ World\ Scene
  TARGETDIR  = .
  TARGET     = $(TARGETDIR)/Tut\ 07\ World\ SceneD.exe
...
ifeq ($(config),release)
  OBJDIR     = obj/Release/Tut\ 07\ World\ Scene
  TARGETDIR  = .
  TARGET     = $(TARGETDIR)/Tut\ 07\ World\ Scene.exe
...
$(TARGET): $(GCH) $(OBJECTS) $(LDDEPS) $(RESOURCES)
	@echo Linking Tut 07 World Scene
	$(SILENT) $(LINKCMD)
	$(POSTBUILDCMDS)
...
clean:
	@echo Cleaning Tut 07 World Scene
ifeq (posix,$(SHELLTYPE))
	$(SILENT) rm -f  $(TARGET)
	$(SILENT) rm -rf $(OBJDIR)
else
...
$(OBJDIR)/World\ Scene.o: World\ Scene.cpp
	@echo $(notdir $<)

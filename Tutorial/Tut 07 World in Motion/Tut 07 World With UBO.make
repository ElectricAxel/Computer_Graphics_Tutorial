...
ifeq ($(config),debug)
  OBJDIR     = obj/Debug/Tut\ 07\ World\ With\ UBO
  TARGETDIR  = .
  TARGET     = $(TARGETDIR)/Tut\ 07\ World\ With\ UBOD.exe
...
ifeq ($(config),release)
  OBJDIR     = obj/Release/Tut\ 07\ World\ With\ UBO
  TARGETDIR  = .
  TARGET     = $(TARGETDIR)/Tut\ 07\ World\ With\ UBO.exe
...
$(TARGET): $(GCH) $(OBJECTS) $(LDDEPS) $(RESOURCES)
	@echo Linking Tut 07 World With UBO
	$(SILENT) $(LINKCMD)
	$(POSTBUILDCMDS)
...
clean:
	@echo Cleaning Tut 07 World With UBO
ifeq (posix,$(SHELLTYPE))
	$(SILENT) rm -f  $(TARGET)
	$(SILENT) rm -rf $(OBJDIR)
else
...
$(OBJDIR)/World\ With\ UBO.o: World\ With\ UBO.cpp
	@echo $(notdir $<)

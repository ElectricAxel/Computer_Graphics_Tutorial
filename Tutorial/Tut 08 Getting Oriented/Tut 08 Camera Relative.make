...
ifeq ($(config),debug)
  OBJDIR     = obj/Debug/Tut\ 08\ Camera\ Relative
  TARGETDIR  = .
  TARGET     = $(TARGETDIR)/Tut\ 08\ Camera\ RelativeD.exe
...
ifeq ($(config),release)
  OBJDIR     = obj/Release/Tut\ 08\ Camera\ Relative
  TARGETDIR  = .
  TARGET     = $(TARGETDIR)/Tut\ 08\ Camera\ Relative.exe
...
$(TARGET): $(GCH) $(OBJECTS) $(LDDEPS) $(RESOURCES)
	@echo Linking Tut 08 Camera Relative
	$(SILENT) $(LINKCMD)
	$(POSTBUILDCMDS)
...
clean:
	@echo Cleaning Tut 08 Camera Relative
ifeq (posix,$(SHELLTYPE))
	$(SILENT) rm -f  $(TARGET)
	$(SILENT) rm -rf $(OBJDIR)
else
...
$(OBJDIR)/CameraRelative.o: CameraRelative.cpp
	@echo $(notdir $<)

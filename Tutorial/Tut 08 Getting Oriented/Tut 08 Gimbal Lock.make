...
ifeq ($(config),debug)
  OBJDIR     = obj/Debug/Tut\ 08\ Gimbal\ Lock
  TARGETDIR  = .
  TARGET     = $(TARGETDIR)/Tut\ 08\ Gimbal\ LockD.exe
...
ifeq ($(config),release)
  OBJDIR     = obj/Release/Tut\ 08\ Gimbal\ Lock
  TARGETDIR  = .
  TARGET     = $(TARGETDIR)/Tut\ 08\ Gimbal\ Lock.exe
...
$(TARGET): $(GCH) $(OBJECTS) $(LDDEPS) $(RESOURCES)
	@echo Linking Tut 08 Gimbal Lock
	$(SILENT) $(LINKCMD)
	$(POSTBUILDCMDS)
...
clean:
	@echo Cleaning Tut 08 Gimbal Lock
ifeq (posix,$(SHELLTYPE))
	$(SILENT) rm -f  $(TARGET)
	$(SILENT) rm -rf $(OBJDIR)
else

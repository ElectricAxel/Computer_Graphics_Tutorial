...
ifeq ($(config),debug)
  OBJDIR     = obj/Debug/Tut\ 08\ Quaternion\ YPR
  TARGETDIR  = .
  TARGET     = $(TARGETDIR)/Tut\ 08\ Quaternion\ YPRD.exe
...
ifeq ($(config),release)
  OBJDIR     = obj/Release/Tut\ 08\ Quaternion\ YPR
  TARGETDIR  = .
  TARGET     = $(TARGETDIR)/Tut\ 08\ Quaternion\ YPR.exe
...
$(TARGET): $(GCH) $(OBJECTS) $(LDDEPS) $(RESOURCES)
	@echo Linking Tut 08 Quaternion YPR
	$(SILENT) $(LINKCMD)
	$(POSTBUILDCMDS)
...
clean:
	@echo Cleaning Tut 08 Quaternion YPR
ifeq (posix,$(SHELLTYPE))
	$(SILENT) rm -f  $(TARGET)
	$(SILENT) rm -rf $(OBJDIR)
else
...
$(OBJDIR)/QuaternionYPR.o: QuaternionYPR.cpp
	@echo $(notdir $<)

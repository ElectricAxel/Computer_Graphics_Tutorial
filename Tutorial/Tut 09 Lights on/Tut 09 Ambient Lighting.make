...
ifeq ($(config),debug)
  OBJDIR     = obj/Debug/Tut\ 09\ Ambient\ Lighting
  TARGETDIR  = .
  TARGET     = $(TARGETDIR)/Tut\ 09\ Ambient\ LightingD.exe
...
ifeq ($(config),release)
  OBJDIR     = obj/Release/Tut\ 09\ Ambient\ Lighting
  TARGETDIR  = .
  TARGET     = $(TARGETDIR)/Tut\ 09\ Ambient\ Lighting.exe
...
$(TARGET): $(GCH) $(OBJECTS) $(LDDEPS) $(RESOURCES)
	@echo Linking Tut 09 Ambient Lighting
	$(SILENT) $(LINKCMD)
	$(POSTBUILDCMDS)
...
clean:
	@echo Cleaning Tut 09 Ambient Lighting
ifeq (posix,$(SHELLTYPE))
	$(SILENT) rm -f  $(TARGET)
	$(SILENT) rm -rf $(OBJDIR)
else
...
$(OBJDIR)/Ambient\ Lighting.o: Ambient\ Lighting.cpp
	@echo $(notdir $<)

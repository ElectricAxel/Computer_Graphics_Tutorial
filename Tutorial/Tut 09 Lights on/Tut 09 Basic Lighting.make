...
ifeq ($(config),debug)
  OBJDIR     = obj/Debug/Tut\ 09\ Basic\ Lighting
  TARGETDIR  = .
  TARGET     = $(TARGETDIR)/Tut\ 09\ Basic\ LightingD.exe
...
ifeq ($(config),release)
  OBJDIR     = obj/Release/Tut\ 09\ Basic\ Lighting
  TARGETDIR  = .
  TARGET     = $(TARGETDIR)/Tut\ 09\ Basic\ Lighting.exe
...
$(TARGET): $(GCH) $(OBJECTS) $(LDDEPS) $(RESOURCES)
	@echo Linking Tut 09 Basic Lighting
	$(SILENT) $(LINKCMD)
	$(POSTBUILDCMDS)
...
clean:
	@echo Cleaning Tut 09 Basic Lighting
ifeq (posix,$(SHELLTYPE))
	$(SILENT) rm -f  $(TARGET)
	$(SILENT) rm -rf $(OBJDIR)
else
...
$(OBJDIR)/Basic\ Lighting.o: Basic\ Lighting.cpp
	@echo $(notdir $<)

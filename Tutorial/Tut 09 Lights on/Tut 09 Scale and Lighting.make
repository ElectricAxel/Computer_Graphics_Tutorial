...
ifeq ($(config),debug)
  OBJDIR     = obj/Debug/Tut\ 09\ Scale\ and\ Lighting
  TARGETDIR  = .
  TARGET     = $(TARGETDIR)/Tut\ 09\ Scale\ and\ LightingD.exe
...
ifeq ($(config),release)
  OBJDIR     = obj/Release/Tut\ 09\ Scale\ and\ Lighting
  TARGETDIR  = .
  TARGET     = $(TARGETDIR)/Tut\ 09\ Scale\ and\ Lighting.exe
...
$(TARGET): $(GCH) $(OBJECTS) $(LDDEPS) $(RESOURCES)
	@echo Linking Tut 09 Scale and Lighting
	$(SILENT) $(LINKCMD)
	$(POSTBUILDCMDS)
...
clean:
	@echo Cleaning Tut 09 Scale and Lighting
ifeq (posix,$(SHELLTYPE))
	$(SILENT) rm -f  $(TARGET)
	$(SILENT) rm -rf $(OBJDIR)
else
...
$(OBJDIR)/Scale\ and\ Lighting.o: Scale\ and\ Lighting.cpp
	@echo $(notdir $<)

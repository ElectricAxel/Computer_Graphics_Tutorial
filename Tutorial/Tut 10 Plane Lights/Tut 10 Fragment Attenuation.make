...
ifeq ($(config),debug)
  OBJDIR     = obj/Debug/Tut\ 10\ Fragment\ Attenuation
  TARGETDIR  = .
  TARGET     = $(TARGETDIR)/Tut\ 10\ Fragment\ AttenuationD.exe
...
ifeq ($(config),release)
  OBJDIR     = obj/Release/Tut\ 10\ Fragment\ Attenuation
  TARGETDIR  = .
  TARGET     = $(TARGETDIR)/Tut\ 10\ Fragment\ Attenuation.exe
...
$(TARGET): $(GCH) $(OBJECTS) $(LDDEPS) $(RESOURCES)
	@echo Linking Tut 10 Fragment Attenuation
	$(SILENT) $(LINKCMD)
	$(POSTBUILDCMDS)
...
clean:
	@echo Cleaning Tut 10 Fragment Attenuation
ifeq (posix,$(SHELLTYPE))
	$(SILENT) rm -f  $(TARGET)
	$(SILENT) rm -rf $(OBJDIR)
else
...
$(OBJDIR)/Fragment\ Attenuation.o: Fragment\ Attenuation.cpp
	@echo $(notdir $<)

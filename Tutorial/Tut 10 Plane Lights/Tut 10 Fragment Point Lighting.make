...
ifeq ($(config),debug)
  OBJDIR     = obj/Debug/Tut\ 10\ Fragment\ Point\ Lighting
  TARGETDIR  = .
  TARGET     = $(TARGETDIR)/Tut\ 10\ Fragment\ Point\ LightingD.exe
...
ifeq ($(config),release)
  OBJDIR     = obj/Release/Tut\ 10\ Fragment\ Point\ Lighting
  TARGETDIR  = .
  TARGET     = $(TARGETDIR)/Tut\ 10\ Fragment\ Point\ Lighting.exe
...
OBJECTS := \
	$(OBJDIR)/Fragment\ Point\ Lighting.o \
...
$(TARGET): $(GCH) $(OBJECTS) $(LDDEPS) $(RESOURCES)
	@echo Linking Tut 10 Fragment Point Lighting
	$(SILENT) $(LINKCMD)
	$(POSTBUILDCMDS)
...
clean:
	@echo Cleaning Tut 10 Fragment Point Lighting
ifeq (posix,$(SHELLTYPE))
	$(SILENT) rm -f  $(TARGET)
	$(SILENT) rm -rf $(OBJDIR)
else
...
$(OBJDIR)/Fragment\ Point\ Lighting.o: Fragment\ Point\ Lighting.cpp
	@echo $(notdir $<)

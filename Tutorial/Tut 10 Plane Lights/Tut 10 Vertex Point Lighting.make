...
ifeq ($(config),debug)
  OBJDIR     = obj/Debug/Tut\ 10\ Vertex\ Point\ Lighting
  TARGETDIR  = .
  TARGET     = $(TARGETDIR)/Tut\ 10\ Vertex\ Point\ LightingD.exe
...
ifeq ($(config),release)
  OBJDIR     = obj/Release/Tut\ 10\ Vertex\ Point\ Lighting
  TARGETDIR  = .
  TARGET     = $(TARGETDIR)/Tut\ 10\ Vertex\ Point\ Lighting.exe
...
OBJECTS := \
	$(OBJDIR)/Vertex\ Point\ Lighting.o \
...
$(TARGET): $(GCH) $(OBJECTS) $(LDDEPS) $(RESOURCES)
	@echo Linking Tut 10 Vertex Point Lighting
	$(SILENT) $(LINKCMD)
	$(POSTBUILDCMDS)
...
clean:
	@echo Cleaning Tut 10 Vertex Point Lighting
ifeq (posix,$(SHELLTYPE))
	$(SILENT) rm -f  $(TARGET)
	$(SILENT) rm -rf $(OBJDIR)
else
...
$(OBJDIR)/Vertex\ Point\ Lighting.o: Vertex\ Point\ Lighting.cpp
	@echo $(notdir $<)

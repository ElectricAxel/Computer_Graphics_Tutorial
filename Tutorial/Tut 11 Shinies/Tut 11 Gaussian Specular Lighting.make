...
ifeq ($(config),debug)
  OBJDIR     = obj/Debug/Tut\ 11\ Gaussian\ Specular\ Lighting
  TARGETDIR  = .
  TARGET     = $(TARGETDIR)/Tut\ 11\ Gaussian\ Specular\ LightingD.exe
...
ifeq ($(config),release)
  OBJDIR     = obj/Release/Tut\ 11\ Gaussian\ Specular\ Lighting
  TARGETDIR  = .
  TARGET     = $(TARGETDIR)/Tut\ 11\ Gaussian\ Specular\ Lighting.exe
...
OBJECTS := \
	$(OBJDIR)/Gaussian\ Specular\ Lighting.o \
...
$(TARGET): $(GCH) $(OBJECTS) $(LDDEPS) $(RESOURCES)
	@echo Linking Tut 11 Gaussian Specular Lighting
	$(SILENT) $(LINKCMD)
	$(POSTBUILDCMDS)
...
clean:
	@echo Cleaning Tut 11 Gaussian Specular Lighting
ifeq (posix,$(SHELLTYPE))
	$(SILENT) rm -f  $(TARGET)
	$(SILENT) rm -rf $(OBJDIR)
else
...
$(OBJDIR)/Gaussian\ Specular\ Lighting.o: Gaussian\ Specular\ Lighting.cpp
	@echo $(notdir $<)

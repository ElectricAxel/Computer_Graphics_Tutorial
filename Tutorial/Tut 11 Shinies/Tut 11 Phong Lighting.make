...
ifeq ($(config),debug)
  OBJDIR     = obj/Debug/Tut\ 11\ Phong\ Lighting
  TARGETDIR  = .
  TARGET     = $(TARGETDIR)/Tut\ 11\ Phong\ LightingD.exe
...
ifeq ($(config),release)
  OBJDIR     = obj/Release/Tut\ 11\ Phong\ Lighting
  TARGETDIR  = .
  TARGET     = $(TARGETDIR)/Tut\ 11\ Phong\ Lighting.exe
...
$(TARGET): $(GCH) $(OBJECTS) $(LDDEPS) $(RESOURCES)
	@echo Linking Tut 11 Phong Lighting
	$(SILENT) $(LINKCMD)
	$(POSTBUILDCMDS)
...
clean:
	@echo Cleaning Tut 11 Phong Lighting
ifeq (posix,$(SHELLTYPE))
	$(SILENT) rm -f  $(TARGET)
	$(SILENT) rm -rf $(OBJDIR)
else
...
$(OBJDIR)/Phong\ Lighting.o: Phong\ Lighting.cpp
	@echo $(notdir $<)

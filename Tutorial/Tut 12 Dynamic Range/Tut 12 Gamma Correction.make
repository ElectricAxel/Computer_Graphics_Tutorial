...
ifeq ($(config),debug)
  OBJDIR     = obj/Debug/Tut\ 12\ Gamma\ Correction
  TARGETDIR  = .
  TARGET     = $(TARGETDIR)/Tut\ 12\ Gamma\ CorrectionD.exe
...
ifeq ($(config),release)
  OBJDIR     = obj/Release/Tut\ 12\ Gamma\ Correction
  TARGETDIR  = .
  TARGET     = $(TARGETDIR)/Tut\ 12\ Gamma\ Correction.exe
...
$(TARGET): $(GCH) $(OBJECTS) $(LDDEPS) $(RESOURCES)
	@echo Linking Tut 12 Gamma Correction
	$(SILENT) $(LINKCMD)
	$(POSTBUILDCMDS)
...
clean:
	@echo Cleaning Tut 12 Gamma Correction
ifeq (posix,$(SHELLTYPE))
	$(SILENT) rm -f  $(TARGET)
	$(SILENT) rm -rf $(OBJDIR)
else
...
$(OBJDIR)/Gamma\ Correction.o: Gamma\ Correction.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(ALL_CXXFLAGS) $(FORCE_INCLUDE) -o "$@" -MF "$(@:%.o=%.d)" -c "$<"

$(OBJDIR)/Lights.o: Lights.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(ALL_CXXFLAGS) $(FORCE_INCLUDE) -o "$@" -MF "$(@:%.o=%.d)" -c "$<"

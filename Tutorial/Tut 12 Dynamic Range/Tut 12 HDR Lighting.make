...
ifeq ($(config),debug)
  OBJDIR     = obj/Debug/Tut\ 12\ HDR\ Lighting
  TARGETDIR  = .
  TARGET     = $(TARGETDIR)/Tut\ 12\ HDR\ LightingD.exe
...
ifeq ($(config),release)
  OBJDIR     = obj/Release/Tut\ 12\ HDR\ Lighting
  TARGETDIR  = .
  TARGET     = $(TARGETDIR)/Tut\ 12\ HDR\ Lighting.exe
...
$(TARGET): $(GCH) $(OBJECTS) $(LDDEPS) $(RESOURCES)
	@echo Linking Tut 12 HDR Lighting
	$(SILENT) $(LINKCMD)
	$(POSTBUILDCMDS)
...
clean:
	@echo Cleaning Tut 12 HDR Lighting
ifeq (posix,$(SHELLTYPE))
	$(SILENT) rm -f  $(TARGET)
	$(SILENT) rm -rf $(OBJDIR)
else
...
$(OBJDIR)/HDR\ Lighting.o: HDR\ Lighting.cpp
	@echo $(notdir $<)

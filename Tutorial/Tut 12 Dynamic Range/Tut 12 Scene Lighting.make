...
ifeq ($(config),debug)
  OBJDIR     = obj/Debug/Tut\ 12\ Scene\ Lighting
  TARGETDIR  = .
  TARGET     = $(TARGETDIR)/Tut\ 12\ Scene\ LightingD.exe
...
ifeq ($(config),release)
  OBJDIR     = obj/Release/Tut\ 12\ Scene\ Lighting
  TARGETDIR  = .
  TARGET     = $(TARGETDIR)/Tut\ 12\ Scene\ Lighting.exe
...
$(TARGET): $(GCH) $(OBJECTS) $(LDDEPS) $(RESOURCES)
	@echo Linking Tut 12 Scene Lighting
	$(SILENT) $(LINKCMD)
	$(POSTBUILDCMDS)
...
clean:
	@echo Cleaning Tut 12 Scene Lighting
ifeq (posix,$(SHELLTYPE))
	$(SILENT) rm -f  $(TARGET)
	$(SILENT) rm -rf $(OBJDIR)
else
...
$(OBJDIR)/Scene\ Lighting.o: Scene\ Lighting.cpp
	@echo $(notdir $<)

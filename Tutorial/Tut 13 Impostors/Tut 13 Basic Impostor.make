...
ifeq ($(config),debug)
  OBJDIR     = obj/Debug/Tut\ 13\ Basic\ Impostor
  TARGETDIR  = .
  TARGET     = $(TARGETDIR)/Tut\ 13\ Basic\ ImpostorD.exe
...
ifeq ($(config),release)
  OBJDIR     = obj/Release/Tut\ 13\ Basic\ Impostor
  TARGETDIR  = .
  TARGET     = $(TARGETDIR)/Tut\ 13\ Basic\ Impostor.exe
...
$(TARGET): $(GCH) $(OBJECTS) $(LDDEPS) $(RESOURCES)
	@echo Linking Tut 13 Basic Impostor
	$(SILENT) $(LINKCMD)
	$(POSTBUILDCMDS)
...
clean:
	@echo Cleaning Tut 13 Basic Impostor
ifeq (posix,$(SHELLTYPE))
	$(SILENT) rm -f  $(TARGET)
	$(SILENT) rm -rf $(OBJDIR)
else
...
$(OBJDIR)/BasicImpostor.o: BasicImpostor.cpp
	@echo $(notdir $<)

...
ifeq ($(config),debug)
  OBJDIR     = obj/Debug/Tut\ 13\ Geometry\ Impostor
  TARGETDIR  = .
  TARGET     = $(TARGETDIR)/Tut\ 13\ Geometry\ ImpostorD.exe
...
ifeq ($(config),release)
  OBJDIR     = obj/Release/Tut\ 13\ Geometry\ Impostor
  TARGETDIR  = .
  TARGET     = $(TARGETDIR)/Tut\ 13\ Geometry\ Impostor.exe
...
$(TARGET): $(GCH) $(OBJECTS) $(LDDEPS) $(RESOURCES)
	@echo Linking Tut 13 Geometry Impostor
	$(SILENT) $(LINKCMD)
	$(POSTBUILDCMDS)
...
clean:
	@echo Cleaning Tut 13 Geometry Impostor
ifeq (posix,$(SHELLTYPE))
	$(SILENT) rm -f  $(TARGET)
	$(SILENT) rm -rf $(OBJDIR)
else
...
$(OBJDIR)/GeomImpostor.o: GeomImpostor.cpp
	@echo $(notdir $<)
